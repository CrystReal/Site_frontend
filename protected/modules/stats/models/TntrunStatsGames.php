...
/**
 * This is the model class for table "tntrun_stats_games".
 *
 * The followings are the available columns in table 'tntrun_stats_games':
 * @property integer $id
 ...
 */
class TntrunStatsGames extends CActiveRecord
{
    /**
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('id, serverId, mapId, winnerId, start, end', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function relations()
    {
        ...
        return array(
            "players" => [self::HAS_MANY, "TntrunStatsPlayers", "gameId"],
     ...
     * @return TntrunStatsGames the static model class
     */
