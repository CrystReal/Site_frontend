...
/**
 * This is the model class for table "qc_stats_games".
 *
 * The followings are the available columns in table 'qc_stats_games':
 * @property integer $id
 ...
 */
class QcStatsGames extends CActiveRecord
{
    /**
    ...
    public function rules()
    {
        ...
        return array(
            array('serverId, winnerId, start, end', 'required'),
            array('serverId, winnerId, start, end', 'numerical', 'integerOnly' => true),
    ...
    public function relations()
    {
        ...
        return array(
            "players" => [self::HAS_MANY, "QcStatsPlayers", "gameId"],
     ...
     * @return QcStatsGames the static model class
     */
