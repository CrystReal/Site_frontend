...
/**
 * This is the model class for table "dk_stats_players_victims".
 *
 * The followings are the available columns in table 'dk_stats_players_victims':
 * @property integer $id
 ...
 */
class DkStatsPlayersVictims extends CActiveRecord
{
    /**
    ...
    {
        return 'dk_stats_players_victims';
    }
     ...
     * @return DkStatsPlayersVictims the static model class
     */
