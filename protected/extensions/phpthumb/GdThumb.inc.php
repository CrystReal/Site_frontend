...
class GdThumb extends ThumbBase
{
    ...
    public function inlineResize($width, $height, $bgColor)
    {
        $this->resize($width, $height);
        if ($this->currentDimensions['width'] != $width || $this->currentDimensions['height'] != $height) {
            $this->workingImage = imagecreatetruecolor($width, $height);
            $white = imagecolorallocate($this->workingImage, $bgColor[0], $bgColor[1], $bgColor[2]);
